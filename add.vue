<template>
  <v-container fluid>
    <v-row justify="center" class="my-5">
      ...
      <v-col cols="12" md="8">
        <v-card class="pa-5" style="border-radius: 20px; background-color: #ffffff;" hover outlined>
          ...
          <v-card-text>
            <v-row>
              <!-- อุณหภูมิ -->
              <v-col cols="12" sm="6">
                <v-card style="border-radius: 20px; background-color: #ffffff;" class="pa-3" hover outlined>
    ...
    <v-row justify="center" class="my-5">
      <!-- Control Card -->
      <v-col cols="12" md="8">
        <v-card style="border-radius: 20px; background-color: #ffffff;" class="pa-5" hover outlined>
